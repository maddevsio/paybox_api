...
RSpec.describe PayboxApi::V4::Client do
  it 'initialize without error' do
    expect { PayboxApi::V4::Client.new merchant_id: 123_456, secret_key: 123_456 }.not_to raise_error
  end

  it 'payments without error' do
    client = PayboxApi::V4::Client.new merchant_id: 123_456, secret_key: 123_456
    expect do
